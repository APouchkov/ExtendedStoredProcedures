...
public struct SqlUdt : IBinarySerialize
{
  ...
  public Object CreateUdtObject(Boolean ALoadBuffer = false)
  {
    ...
    if(FTypeName.Substring(0, 5).Equals("TList"))
    {
  ...
  public void Read(System.IO.BinaryReader r)
  {
    ...
    Int32 Len = INT_EMPTY.TParams_EMPTY.Read7BitEncodedInt(r);
  ...
  {
    w.Write(FTypeName);
    INT_EMPTY.TParams_EMPTY.Write7BitEncodedInt(w, (Int32)FBuffer.Length);
    w.Write(FBuffer);
  }
